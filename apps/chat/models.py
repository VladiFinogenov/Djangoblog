...
class Group(models.Model):
    """
    Групповая модель,
    в которой несколько пользователей могут делиться идеями
    и обсуждать их.
    """
    ...
    def add_user_to_group(self, user: User):
        ...
        для добавления пользователя в группу и создания объекта
        """
    ...
    def remove_user_from_group(self, user: User):
        """
        Функция для удаления членов группы,
        когда они выходят из группы чата.
        """
